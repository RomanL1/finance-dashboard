...
#table(
  ...
  [No fault-injection test for onboarding and category transfer], [A regression to sequential writes there would pass all suites; only the manual check QS-1 covers onboarding.], [Add trigger-based tests like the budget ones in `budget.e2e-spec.ts`.],
